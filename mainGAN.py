...
def get_args_parser():
    parser = argparse.ArgumentParser('HyperGAN training and evaluation script', add_help=False)
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='/home/wwx/dataSet/', type=str,
                        help='dataset path')
    # parser.add_argument('--data-path', default='/home/wangshaofan/data_stu/lost+found/wwx/datastes/', type=str,
    #                     help='dataset path')
    ...
    parser.add_argument('--output-dir', default='',
                        help='Dont use that')
    parser.add_argument('--output-basedir', default='/home/wwx/classification/hyper_gan/checkpoint',
    ...
    parser.add_argument('--options', default=["options/data/cifar100_10-10.yaml", "options/data/cifar100_order1.yaml", "options/model/hyper_gan.yaml"], nargs='*')
    # parser.add_argument('--options', default=[], nargs='*')

    # hyper related
    parser.add_argument('--hypergan', action='store_true', default=True,
...
def main(args):
    ...
    for task_id, dataset_train in enumerate(scenario_train):
        ...
        # Ensembling
        if args.hypergan:
            model_without_ddp = factory.update_hyper_gan(model_without_ddp, task_id, args)
        ...
        if task_id > 0 and not args.hypergan:
    ...
    if args.name:
        ...
        if log_path is not None and utils.is_main_process():test
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('hyper training and evaluation script', parents=[get_args_parser()])
